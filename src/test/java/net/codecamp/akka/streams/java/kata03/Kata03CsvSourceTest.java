...
public class Kata03CsvSourceTest {
    ...
    */
    ...
    @Test
    public void expectFlowOfStringToTemperatureReading() throws InterruptedException, ExecutionException, TimeoutException {
        final ActorSystem system = ActorSystem.create("Kata03CsvSourceTest");
        final Materializer materializer = ActorMaterializer.create(system);

        Source<String, CompletionStage<IOResult>> source = Kata03CsvSource.createSourceOfLinesInFileKata03Csv();
        assertNotNull("Source must not be null.", source);

        Flow<String, TemperatureReading, NotUsed> flow = Kata03CsvSource.createFlowOfStringToTemperatureReading();
    ...
    private List<TemperatureReading> createExpectedList() {
        ...
        expectedList.add(new TemperatureReading("548e841a-6d98-4591-b4f9-3cc6ec04776d",
                Instant.parse("2017-01-05T10:00:00Z"), 20.0F, TemperatureUnit.DEGREES_CELSIUS));
        expectedList.add(new TemperatureReading("d7256984-06bf-4bec-983c-428239dd0cce",
                Instant.parse("2017-01-05T10:15:00Z"), 20.3F, TemperatureUnit.DEGREES_CELSIUS));
        expectedList.add(new TemperatureReading("1d651905-0d0d-4c0c-ad93-49f893b209ca",
                Instant.parse("2017-01-05T10:30:00Z"), 20.5F, TemperatureUnit.DEGREES_CELSIUS));
        expectedList.add(new TemperatureReading("af544d18-b3fe-4ea6-a6bb-fcc3677b090c",
                Instant.parse("2017-01-05T10:45:00Z"), 21.1F, TemperatureUnit.DEGREES_CELSIUS));
